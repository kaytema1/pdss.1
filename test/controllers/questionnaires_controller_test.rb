...
class QuestionnairesControllerTest < ActionController::TestCase
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post :create, questionnaire: { answer: @questionnaire.answer, comment: @questionnaire.comment, patient_visit_id: @questionnaire.patient_visit_id, question: @questionnaire.question }
    end
  ...
  test "should update questionnaire" do
    patch :update, id: @questionnaire, questionnaire: { answer: @questionnaire.answer, comment: @questionnaire.comment, patient_visit_id: @questionnaire.patient_visit_id, question: @questionnaire.question }
    assert_redirected_to questionnaire_path(assigns(:questionnaire))
  end
